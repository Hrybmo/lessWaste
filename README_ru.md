...
- TyCo = Выполнять стартовую прочистку, когда тип или цвет отличаются от последней нити, использованной в хотэнде
- Ty = Выполнять стартовую прочистку, когда тип отличается от последней нити, использованной в хотэнде
